...
void I2C_SendAddress(I2C_REGISTERS_t *I2Cx,uint8_t Address , I2C_Direction Direction)
{
...
void MCAL_I2C_Master_TX(I2C_REGISTERS_t *I2Cx,uint8_t devAddr,uint8_t * dataOut,uint32_t dataLen , Stop_Condition Stop, Repeated_Start start){
